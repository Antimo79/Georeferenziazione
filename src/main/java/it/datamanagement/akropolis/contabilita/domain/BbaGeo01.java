...
public class BbaGeo01 implements Serializable {
    ...
    @OneToMany(mappedBy = "bbaGeo01")
    private Set<CutcUtzUbic> idRecInts = new HashSet<>();
    ...
    public Set<CutcUtzUbic> getIdRecInts() {
        return idRecInts;
    }

    public BbaGeo01 idRecInts(Set<CutcUtzUbic> cutcUtzUbics) {
        this.idRecInts = cutcUtzUbics;
        return this;
    }

    public BbaGeo01 addIdRecInt(CutcUtzUbic cutcUtzUbic) {
        this.idRecInts.add(cutcUtzUbic);
        cutcUtzUbic.setBbaGeo01(this);
        return this;
    }

    public BbaGeo01 removeIdRecInt(CutcUtzUbic cutcUtzUbic) {
        this.idRecInts.remove(cutcUtzUbic);
        cutcUtzUbic.setBbaGeo01(null);
        return this;
    }

    public void setIdRecInts(Set<CutcUtzUbic> cutcUtzUbics) {
        this.idRecInts = cutcUtzUbics;
    }
